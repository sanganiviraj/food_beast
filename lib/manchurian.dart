...
class manchurian extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      Column(crossAxisAlignment: CrossAxisAlignment.start,
        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: AssetImage('assets/images/manchuriyam.jpg'),
                                fit: BoxFit.cover
                              )
                            ),
                          )
          ...
          Padding(
            padding: const EdgeInsets.only(left: 20),
            child: Text("Manchurian is a class of Indian Chinese dishes made by roughly chopping and deep-frying ingredients such as chicken, cauliflower (gobi), prawns, fish, mutton, and paneer, and then sautéeing it in a sauce flavored with soy sauce.",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w300,color: Colors.black45),),
